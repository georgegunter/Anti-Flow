...
if __name__ == '__main__':
	...
	want_process_single_lane_attack_monte_carlo = True

	if(want_process_single_lane_attack_monte_carlo):
		...
		if(want_process_single_lane_max_velocity):
			...
			rec_error_repo_path = '/Volumes/My Passport for Mac/Traffic_attack_sim_results/max_velocity/single_lane_ring_road_attack_monte_carlo_rec_errors'
		...
		want_process_single_lane_radar_warp = True
		if(want_process_single_lane_radar_warp):

			print('Begining processing radar scaling rec errors.')

			sim_repo_path = '/Volumes/My Passport for Mac/Traffic_attack_sim_results/Radar_warp/single_lane_ring_road_attack_monte_carlo'

			rec_error_repo_path = '/Volumes/My Passport for Mac/Traffic_attack_sim_results/Radar_warp/single_lane_ring_road_attack_monte_carlo_rec_errors'
			...
			print('Finished processing radar scaling rec errors.')




		want_process_single_lane_RDA = True
		if(want_process_single_lane_radar_warp):

			print('Beginning processing decel attack rec errors.')

			sim_repo_path = '/Volumes/My Passport for Mac/Traffic_attack_sim_results/RDA/single_lane_ring_road_attack_monte_carlo'

			rec_error_repo_path = '/Volumes/My Passport for Mac/Traffic_attack_sim_results/RDA/single_lane_ring_road_attack_monte_carlo_rec_errors'
			...
			print('Finished processing decel attack rec errors.')
	...
	want_process_double_lane_attack_sweep = False

	if(want_process_double_lane_attack_sweep):
		...
		want_process_double_lane_max_velocity = False
