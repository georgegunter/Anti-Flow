...
def get_flow_params_with_attack(attack_duration,
	...
	SIM_LENGTH = 1800 #simulation length in seconds
	# SIM_LENGTH = 300
	...
	WARMUP_STEPS = int(horizon/3) #Attack vehicles don't attack before this # of steps
...
def run_attack_sim(attack_duration,attack_magnitude,acc_penetration,attack_penetration,inflow,emission_path):

	flow_params = get_flow_params_with_attack(attack_duration,attack_magnitude,acc_penetration,inflow,emission_path,attack_penetration)
...
@ray.remote
def run_attack_sim_ray(attack_duration,attack_magnitude,acc_penetration,attack_penetration,inflow,emission_path):

	file_name_with_version = run_attack_sim(attack_duration,attack_magnitude,acc_penetration,attack_penetration,inflow,emission_path)

	return file_name_with_version


def run_batch_random_sims(attack_magnitude_range,attack_duration_range,acc_penetration,attack_penetration,inflow,num_samples,emission_path):

	attack_magnitude_vals = np.random.rand(num_samples)
	...
	attack_duration_vals = np.random.rand(num_samples)
	...
	for i in range(num_samples):
		...
		attack_result_ids.append(run_attack_sim_ray.remote(attack_duration,attack_magnitude,acc_penetration,attack_penetration,inflow,emission_path))
...
if __name__ == '__main__':
	...
	emission_path = '/Volumes/My Passport for Mac/i24_random_sample'
	acc_penetration = 0.2
