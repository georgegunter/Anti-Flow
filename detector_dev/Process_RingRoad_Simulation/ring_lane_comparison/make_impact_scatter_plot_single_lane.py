...
if __name__ == '__main__':
	...
	impacts_list = np.loadtxt('performance_metrics_single_lane.csv',delimiter=',',dtype=str)
	...
	fig.suptitle('Attack impacts on single-lane ring',fontsize=25)
	plt.savefig("Single_lane_RDA_parameter_sweep_impacts.png",bbox_inches='tight')
	...
	fig.suptitle('1 lane RR',fontsize=25)

	plt.savefig("Single_lane_RDA_parameter_sweep_correlations.png",bbox_inches='tight')
