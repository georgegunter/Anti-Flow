...
if __name__ == '__main__':
	...
	want_process_attacks = True
	if(want_process_attacks):
		print('Beginning getting MpVRE values...')
	...
	want_process_benigns = False
	if(want_process_benigns):

		rec_error_repo_path = '/Volumes/My Passport for Mac/Traffic_attack_sim_results/benign_single_lane_ring/rec_errors'
		get_MpVRE_for_all_files_in_repo(rec_error_repo_path)

		rec_error_repo_path = '/Volumes/My Passport for Mac/Traffic_attack_sim_results/benign_double_lane_ring/rec_errors'
		get_MpVRE_for_all_files_in_repo(rec_error_repo_path)
