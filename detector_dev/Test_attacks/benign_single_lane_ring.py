...
def run_sim_benign(emission_path):
    ...
    driver_controller_list_benign = make_benign_driver_list_single_lane()
...
if __name__ == '__main__':
    emission_path = '/Volumes/My Passport for Mac/Traffic_attack_sim_results/benign_single_lane_ring'
    ...
    file_name_no_version = 'ring_single_lane_length_600'
