...
if __name__ == '__main__':
    ...
    # training_data_file_path = '/Volumes/My Passport for Mac/single_lane_ring_road_attack_parameter_sweep/ring_600m_single_lane_TAD_0.0_ADR_0.0_ver_5.csv'
    ...
    if(model_is_trained):
        model_path = '/Users/vanderbilt/Desktop/General_research_tools/Anti-Flow/detector_dev/Process_RingRoad_Simulation/models/cnn_lstm_ae_normalized_ring_detector.pt'
    ...
    want_rec_errors = True


    if(want_rec_errors):
        sim_repo_path = '/Volumes/My Passport for Mac/Traffic_attack_sim_results/RDA/single_lane_ring_road_parameter_monte_carlo/strong_attack'

        rec_error_repo_path = '/Volumes/My Passport for Mac/Traffic_attack_sim_results/RDA/single_lane_ring_road_parameter_monte_carlo/strong_attack/normalized_rec_errors'
