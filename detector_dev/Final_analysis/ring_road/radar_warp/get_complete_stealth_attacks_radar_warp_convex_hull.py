...
hull_label_repo_path = '/Volumes/My Passport for Mac/Traffic_attack_sim_results/Radar_warp/single_lane_ring_road_attack_monte_carlo_hull_labels'
...
if __name__ == '__main__':
	...
	if(want_figures):
		...
		if(want_pareto_subplot):
			...
			plt.savefig('ring_complete_stealth_hull_pareto.pdf',bbox_inches='tight')
