...
ADDITIONAL_NET_PARAMS = {
    ...
    "pre_on_ramp_length": 200,
    # length of the highway past the merge
    "post_on_ramp_length": 100,
    # length of merge section
    "merge_length": 50,
    # number of lanes in the merge
    "merge_lanes": 1,
    # number of lanes in on-ramp
    "on_ramp_lanes":1,
...
class MergeNetwork(Network):
    ...
    * **on_ramp_length** : length of the merge edge
    * **pre_on_ramp_length** : length of the highway leading to the merge
    * **post_on_ramp_length** : length of the highway past the merge
    ...
    * **speed_limit** : max speed limit of the network
    ...
    def specify_nodes(self, net_params):
        """See parent class."""
        angle = pi / 4
        merge = net_params.additional_params["on_ramp_length"]
        premerge = net_params.additional_params["pre_on_ramp_length"]
        postmerge = net_params.additional_params["post_on_ramp_length"]

        # TO DO: add extra lane on merging section of freeway
    ...
    def specify_edges(self, net_params):
        """See parent class."""
        on_ramp = net_params.additional_params["on_ramp_length"]
        premerge = net_params.additional_params["pre_on_ramp_length"]
        postmerge = net_params.additional_params["post_on_ramp_length"]
    ...
    def specify_edge_starts(self):
        """See parent class."""
        premerge = self.net_params.additional_params["pre_on_ramp_length"]
        postmerge = self.net_params.additional_params["post_on_ramp_length"]
