...
def process_sim(emission_file_path,
    ...
    sim_name = sim_name[:-4]+'_rec_error.csv'
...
if __name__ == '__main__':
    ...
    loss_emission_repo = '/Volumes/My Passport for Mac/Misc'

    file_name = 'Dur_300_Mag_-0.5_Inflow_1800_ACCPenetration_0.2_AttackPenetration_0.05.csv'

    emission_file_path = os.path.join(loss_emission_repo,file_name)


    warmup_period = 0


    process_sim(emission_file_path,
        loss_emission_repo,
        model,
        warmup_period=warmup_period,
        normalizing_factors=[30.0,28.41799494,500.0,23.09151303])
